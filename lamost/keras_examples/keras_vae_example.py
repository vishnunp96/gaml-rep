...
def plot_results(models, data, batch_size=128, dir_name="vae_mnist"):
	...
	if decoder.input_shape[1]!=2:
		...
		# display a 2D plot of the digit classes in the latent space (using t-SNE)
	...
	filename = os.path.join(dir_name, "digits_over_latent.png")
	...
	for i, yi in enumerate(grid_y):
		for j, xi in enumerate(grid_x):
			...
			z_sample = np.random.normal(size=(1,decoder.input_shape[1]))
...
if __name__ == '__main__':
	...
	if args.weights:
		...
		vae.save_weights(vae.name+'_mnist.h5')
