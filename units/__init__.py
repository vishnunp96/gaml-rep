...
def alias_unit(new_symbol, base_symbol, is_si=False):
	"""Shortcut for adding a new symbol for an existing unit."""
	assert base_symbol in REGISTRY and new_symbol not in REGISTRY
	return AliasedUnit(new_symbol, unit(base_symbol), is_si)
